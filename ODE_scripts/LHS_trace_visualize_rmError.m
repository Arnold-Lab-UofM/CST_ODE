...
function LHS_trace_visualize_rmError(all_run_mat,newValueMat,dirName,pidx,sp_p,ep_p,time_post)
...
%         legend(p,[sp_names])
        ...
        filenm = strcat('Sum-Traj-',num2str(val_id),'.fig');
        saveas(cf,filenm)
%         
