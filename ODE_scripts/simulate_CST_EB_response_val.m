...
function [dirName] = simulate_CST_EB_response_val(ybase,ss_type,StbleSS,sel_nets,S,Jmat,Type,perChange,sp_p,ep_p,time_post,plotTraj,vectorCell,pidx,newValueMat)
